...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dataset', '0002_alter_exchange_options_alter_market_options_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_washes', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position_status', models.CharField(choices=[('unknown', 'Unknown'), ('open', 'Open'), ('closed', 'Closed')], default='open', max_length=7)),
                ...
                ('_portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='positions', related_query_name='core.portfolio', to='trackrecord.portfolio')),
                ('_symbol', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='positions', related_query_name='core.symbol', to='dataset.symbol')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', related_query_name='core.symbol', to='dataset.symbol')),
                ('_portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', related_query_name='core.portfolio', to='trackrecord.portfolio')),
                ('_position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', related_query_name='core.position', to='trackrecord.position')),
            ],
            options={
