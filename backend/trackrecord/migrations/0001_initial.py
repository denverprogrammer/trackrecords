# Generated by Django 4.0 on 2023-05-02 08:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trackrecord_order_orders', related_query_name='trackrecord_orders', to='trackrecord.portfolio')),
                ('position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trackrecord_order_orders', related_query_name='trackrecord_orders', to='trackrecord.position')),
                ('symbol', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trackrecord_order_orders', related_query_name='trackrecord_orders', to='dataset.symbol')),
            ],
            options={
                'abstract': False,
            },
